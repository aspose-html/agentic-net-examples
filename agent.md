...
- Use the category-level `agent.md` file for local conventions and the root rules below for repository-wide boundaries.
...
- Examples: 37
- Guide: [agent.md](./advanced_html_editing/agent.md)

### data_extraction
- Examples: 81
- Guide: [agent.md](./data_extraction/agent.md)

### epub_converter
- Examples: 143
- Guide: [agent.md](./epub_converter/agent.md)

### extract_images_from_website
- Examples: 37
- Guide: [agent.md](./extract_images_from_website/agent.md)

### extract_svg_from_website
- Examples: 30
- Guide: [agent.md](./extract_svg_from_website/agent.md)

### fine_tuning_converters
- Examples: 121
- Guide: [agent.md](./fine_tuning_converters/agent.md)

### html_converter
- Examples: 198
- Guide: [agent.md](./html_converter/agent.md)

### html_navigation
- Examples: 120
- Guide: [agent.md](./html_navigation/agent.md)

### markdown_converter
- Examples: 78
- Guide: [agent.md](./markdown_converter/agent.md)

### markdown_processing
- Examples: 119
- Guide: [agent.md](./markdown_processing/agent.md)

### message_handlers
- Examples: 98
- Guide: [agent.md](./message_handlers/agent.md)

### mhtml_converter
- Examples: 107
- Guide: [agent.md](./mhtml_converter/agent.md)

### save_file_from_url
- Examples: 28
- Guide: [agent.md](./save_file_from_url/agent.md)

### svg_converter
- Examples: 105
- Guide: [agent.md](./svg_converter/agent.md)

### web_accessibility
- Examples: 96
- Guide: [agent.md](./web_accessibility/agent.md)

### website_to_html
- Examples: 30
- Guide: [agent.md](./website_to_html/agent.md)

### working_with_html_documents
- Examples: 329
- Guide: [agent.md](./working_with_html_documents/agent.md)

### working_with_html_templates
- Examples: 45
- Guide: [agent.md](./working_with_html_templates/agent.md)

## Repository Structure

Examples are organized by feature category:

- `advanced_html_editing/` - 37 example(s); guide: [`agent.md`](./advanced_html_editing/agent.md)
- `data_extraction/` - 81 example(s); guide: [`agent.md`](./data_extraction/agent.md)
- `epub_converter/` - 143 example(s); guide: [`agent.md`](./epub_converter/agent.md)
- `extract_images_from_website/` - 37 example(s); guide: [`agent.md`](./extract_images_from_website/agent.md)
- `extract_svg_from_website/` - 30 example(s); guide: [`agent.md`](./extract_svg_from_website/agent.md)
- `fine_tuning_converters/` - 121 example(s); guide: [`agent.md`](./fine_tuning_converters/agent.md)
- `html_converter/` - 198 example(s); guide: [`agent.md`](./html_converter/agent.md)
- `html_navigation/` - 120 example(s); guide: [`agent.md`](./html_navigation/agent.md)
- `markdown_converter/` - 78 example(s); guide: [`agent.md`](./markdown_converter/agent.md)
- `markdown_processing/` - 119 example(s); guide: [`agent.md`](./markdown_processing/agent.md)
- `message_handlers/` - 98 example(s); guide: [`agent.md`](./message_handlers/agent.md)
- `mhtml_converter/` - 107 example(s); guide: [`agent.md`](./mhtml_converter/agent.md)
- `save_file_from_url/` - 28 example(s); guide: [`agent.md`](./save_file_from_url/agent.md)
- `svg_converter/` - 105 example(s); guide: [`agent.md`](./svg_converter/agent.md)
- `web_accessibility/` - 96 example(s); guide: [`agent.md`](./web_accessibility/agent.md)
- `website_to_html/` - 30 example(s); guide: [`agent.md`](./website_to_html/agent.md)
- `working_with_html_documents/` - 329 example(s); guide: [`agent.md`](./working_with_html_documents/agent.md)
- `working_with_html_templates/` - 45 example(s); guide: [`agent.md`](./working_with_html_templates/agent.md)

Each category folder contains standalone `.cs` files and a category-specific `agent.md` guide.
